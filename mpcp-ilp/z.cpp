            ...
            printPartitioning();
               ...
               if(assignedTaskCount == tasks.size())
               {
                    ...
                    for(int i=0;i<tasks.size();i++)
                    {
                        ...
                        test<<i<<"\t"<<tasks[i].b.totRespTime<<"\t"<<tasks[i].b.rmpcp<<"\t"<<tasks[i].b.lmpcp<<endl; 
                    }
                     test<<"=========================================="<<endl;
                    ...
                    if(rval==1)
                      ...
                      for(int i=0;i<tasks.size();i++)
                      {
                          ...
                          if(tasks[i].b.totRespTime - tasks[i].ilpR > 0.01 || tasks[i].b.totRespTime - tasks[i].ilpR < -0.01 )
                          {
